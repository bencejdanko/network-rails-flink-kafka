...
# Generated 2025-03-05 14:52:22.398948 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
class TrackingID (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTTDData_v1.xsd', 23, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.thalesgroup.com/rtti/PushPort/TDData/v1}berth uses Python identifier berth
    __berth = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'berth'), 'berth', '__httpwww_thalesgroup_comrttiPushPortTDDatav1_TrackingID_httpwww_thalesgroup_comrttiPushPortTDDatav1berth', False, pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTTDData_v1.xsd', 28, 3), )
...
class FullTDBerthID (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTTDData_v1.xsd', 16, 1)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __area._DeclarationLocation = pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTTDData_v1.xsd', 19, 4)
    __area._UseLocation = pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTTDData_v1.xsd', 19, 4)
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(TrackingID._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'berth')), pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTTDData_v1.xsd', 28, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(TrackingID._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'incorrectTrainID')), pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTTDData_v1.xsd', 33, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(TrackingID._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'correctTrainID')), pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTTDData_v1.xsd', 38, 3))
