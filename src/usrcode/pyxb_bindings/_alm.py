...
# Generated 2025-03-05 14:52:22.402030 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
class AlarmID (pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 15, 1)
...
class RTTIAlarmData (pyxb.binding.basis.complexTypeDefinition):
    ...
    __id._DeclarationLocation = pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 43, 2)
    __id._UseLocation = pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 43, 2)
...
RTTIAlarm._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'set'), RTTIAlarmData, scope=RTTIAlarm, documentation='Set a new alarm.', location=pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 54, 3)))

RTTIAlarm._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'clear'), AlarmID, scope=RTTIAlarm, documentation='Clear an existing alarm. The contents identify the unique alarm identifier that has been cleared.', location=pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 59, 3)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(RTTIAlarm._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'set')), pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 54, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(RTTIAlarm._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'clear')), pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 59, 3))
...
RTTIAlarmData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tdAreaFail'), _ImportedBinding__ct.TDAreaIDType, scope=RTTIAlarmData, documentation='Alarm for a single TD area failure. Contents identify the failed area code.', location=pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 27, 3)))

RTTIAlarmData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tdFeedFail'), pyxb.binding.datatypes.anyType, scope=RTTIAlarmData, documentation='Alarm for the failure of the entire TD feed into Darwin.', location=pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 32, 3)))

RTTIAlarmData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tyrellFeedFail'), pyxb.binding.datatypes.anyType, scope=RTTIAlarmData, documentation='Alarm for the failure of the Tyrell feed into Darwin.', location=pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 37, 3)))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(RTTIAlarmData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tdAreaFail')), pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(RTTIAlarmData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tdFeedFail')), pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 32, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(RTTIAlarmData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tyrellFeedFail')), pyxb.utils.utility.Location('/home/bence/DATA-228/stomp-client-python/ppv16/rttiPPTAlarms_v1.xsd', 37, 3))
